export default function AnimatedTools() {
  return (
    <svg
      className="w-[25px] h-[25px] cursor-pointer group"
      viewBox="0 0 32 32"
      fill="currentColor"
    ...
    >
      ...
      <path
        ...
        className="transition-transform duration-300 group-hover:animate-tools"
      />
      <style>
        {`
          @keyframes toolsMove {
          ...
          .group-hover\\:animate-tools:hover {
            animation: toolsMove 1s infinite;
